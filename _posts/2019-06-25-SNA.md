...
Once we are familiar with the data set and its behavior within Gephi, more parameters can be applied. The parameters are: Average Degree, Average Weighted Degree, Modularity and Eigenvector Centrality.
